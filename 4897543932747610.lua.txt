...
local Window = Library:MakeWindow({
    Title = "🔥 Fire Hub | Brookhaven",
    SubTitle = "By: Frost230_0",
    LoadText = "Carregando Fire Hub...",
...
Name = "Fire Hub | Brookhaven",
Description = "Join server",
Logo = "rbxassetid://126713579020014",
Invite = "https://discord.gg/6tX42RS8G9"
})
...
local Troll = Window:MakeTab({ Title = "Trollar Jogadores", Icon = "user" })
...
local names = {
    ...
    {"Fã do blox_doido", " Fã do blox_doido "},
    {"Fã do Pedro", " Fã do Pedro "},
    {"Fire God !", " Fire God ! "},
    {"Anônimo", " Anônimo "},
    {"Tubers93", " Tubers93 "},
    {"CO0kild", " CO0kild "}
...
local flingsTab = Window:MakeTab({
    Title = "Skybox",
    Icon = "rbxassetid://6023426915" -- ícone de nuvem
})
...
local CustomShirtId = nil -- ID da roupa da TextBox

----------------------------
-- SEÇÃO 1: Roupa Personalizada + Skybox
----------------------------
local Section1 = flingsTab:AddSection({"Skybox e Roupa"})

-- Caixa de texto para inserir ID da roupa
flingsTab:AddTextBox({
    ...
    Callback = function(text)
        CustomShirtId = text
        print("ID da roupa definido para:", CustomShirtId)
    end
})

-- Função para trocar a camisa do personagem
local function ChangeShirt(id)
    ...
    if character then
        ...
        print("Roupa alterada para ID:", id)
    end
end

-- Botão para ativar/desativar Skybox
flingsTab:AddButton({
    ...
    Callback = function()
        ...
        if SkyboxActive then
            ...
            -- Animação de planking (andar duro)
